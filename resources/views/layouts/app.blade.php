            ...
            <div class="kia-topbar-actions">
                ...
                <div class="kia-dropdown" id="userDropdown">
                    ...
                    <div class="kia-dropdown-menu">
                        ...
                        <a href="{{ route('two-factor.settings') }}" class="kia-dropdown-item">
                            ...
                            {{ __('two_factor.settings_title') }}
                            @if(auth()->user()->hasTwoFactorEnabled())
                            <span class="pill pill-ok" style="margin-left:auto;font-size:.65rem;">{{ __('Active') }}</span>
                            @endif
                        </a>

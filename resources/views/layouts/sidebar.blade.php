...
<nav class="kia-sidebar" id="kiaSidebar">
    ...
    <div class="kia-nav">
        ...
        {{-- Common: Academic Calendar — needs no permission, school-wide informational data (term dates, holidays, exam dates) --}}
        <a href="{{ route('academic-calendar.index') }}" class="kia-nav-item {{ request()->routeIs('academic-calendar.*') || request()->routeIs('holidays.*') ? 'active' : '' }}">
            <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                <rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/>
                <line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/>
            </svg>
            {{ __('academic_calendar.nav') }}
        </a>
        ...
        @if($can(P::CURRICULUM_VIEW))
        <a href="{{ route('curriculum.index') }}" class="kia-nav-item {{ request()->routeIs('curriculum.*') ? 'active' : '' }}">
            <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">

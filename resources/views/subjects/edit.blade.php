    ...
    <div class="kia-card" style="max-width:560px">
        <form method="POST" action="{{ route('subjects.update', $subject) }}">
            ...
            <div class="form-group">
                ...
                <input type="number" name="coefficient" step="0.01" min="0.01" max="99.99" class="form-control @error('coefficient') is-invalid @enderror" value="{{ old('coefficient', $subject->coefficient) }}">

<x-app-layout>
    ...
    <div class="kia-page-header">
        ...
        <div style="display:flex;gap:.5rem">
            <a href="{{ route('students.export-excel', request()->query()) }}" class="btn btn-ghost">↓ Excel</a>
            <a href="{{ route('students.export-pdf', request()->query()) }}" class="btn btn-ghost" target="_blank">↓ PDF</a>
            @can('students.create')
            <a href="{{ route('students.import') }}" class="btn btn-ghost">↑ Import</a>

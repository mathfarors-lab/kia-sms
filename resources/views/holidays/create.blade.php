<x-app-layout>
    <x-slot name="title">{{ __('academic_calendar.add_holiday') }}</x-slot>

    <div class="kia-page-header">
        <h1 class="kia-page-title">{{ __('academic_calendar.add_holiday') }}</h1>
    ...
    <div class="kia-card" style="max-width:520px">
        <form method="POST" action="{{ route('holidays.store') }}">
            ...
            <div class="form-actions">
                <button type="submit" class="btn btn-primary">{{ __('academic_calendar.add_holiday') }}</button>
